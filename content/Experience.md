...
- Contributed to the Verdant smart thermostat platform, an AI-powered energy management system for the hospitality industry that uses embedded deep learning to reduce HVAC runtime by up to 45% in unoccupied hotel rooms, serving major hotel chains and multi-dwelling properties
